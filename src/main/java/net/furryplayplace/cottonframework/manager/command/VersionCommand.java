...
public class VersionCommand implements com.mojang.brigadier.Command<ServerCommandSource>, Predicate<ServerCommandSource>, SuggestionProvider<ServerCommandSource> {
    ...
    public int run(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        context.getSource().sendFeedback(() -> Text.literal(Formatting.GRAY + "Current Cotton Version: v" + Formatting.AQUA + MOD_VERSION),false);
        context.getSource().sendFeedback(() -> Text.literal(Formatting.GRAY + "Current Fabric Version: v" + Formatting.AQUA + FabricLoaderImpl.VERSION),false);
        return 0;
    }
}