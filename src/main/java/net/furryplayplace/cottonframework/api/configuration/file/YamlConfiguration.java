package net.furryplayplace.cottonframework.api.configuration.file;

import com.google.common.base.Preconditions;
import net.furryplayplace.cottonframework.CottonFramework;
import net.furryplayplace.cottonframework.api.configuration.ConfigurationSection;
import net.furryplayplace.cottonframework.api.configuration.InvalidConfigurationException;
import net.furryplayplace.cottonframework.api.configuration.serialization.ConfigurationSerialization;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(@NotNull File file) {
        ...
        try {
            ...
            CottonFramework.getInstance().getLogger().error("Cannot load " + file, ex);
    ...
    public static YamlConfiguration loadConfiguration(@NotNull Reader reader) {
        ...
        try {
            ...
            CottonFramework.getInstance().getLogger().error("Cannot load configuration from stream", ex);
        } catch (InvalidConfigurationException ex) {
            CottonFramework.getInstance().getLogger().error("Cannot load configuration from stream", ex);
        }
